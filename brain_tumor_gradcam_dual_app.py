...
if uploaded_file is not None:
    ...
    # GradCAM for CNN-only model (better heatmap)
    if st.button("Show GradCAM from CNN-only Model (Better Focus)"):
        ...
        # CHANGE LAYER BELOW based on cnn_only_model
        heatmap = make_gradcam_heatmap(img_input, cnn_model, last_conv_layer_name="conv2d_2")
